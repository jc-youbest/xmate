...
- U-001 AppRoot
  ...
  - U-101 WritingScreen — the writing variant of the Content Screen; the app opens straight into it (F-051)
    - U-102 WritingTopBar — thin top bar
      ...
      - U-113 ZoomResetButton — live zoom percentage while zoomed; tap restores 100% (F-053)
    ...
    - U-112 ZoomHUD — transient centered percentage readout while pinch-zooming; fades 1 s after fingers lift (F-053)
